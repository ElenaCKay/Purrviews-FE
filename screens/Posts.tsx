		...
		<ScrollView tw="bg-[#e9d2b0]">
			...
			<View tw="items-center">
				...
				{imagePerm ? (
					...
					<Text>Grant Media Permissions To Upload</Text>
				)}
				<Input
					tw="shadow appearance-none border rounded w-full py-1 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
					id="location"
				...
				></Input>
				<TouchableOpacity onPress={postNewPost} style={styles.submitButton}>
					<Text>Submit</Text>
				</TouchableOpacity>
			</View>
			<View tw="h-full">
				...
				<View>
					{postsData.map((post) => (
						<Card key={post._id} containerStyle={styles.card}>
							...
							<Text tw="text-center">
								{post.username} {post.posted_at.slice(0, 16).replace("T", " ")}
							</Text>
							<Text tw="text-center">
